...
module Program =
    ...
    type Arguments =
        | [<MainCommand ; ExactlyOnce ; Last>] Files of
        ...
        interface IArgParserTemplate with
            member s.Usage =
                ...
                | Precision _ ->
                    $"the precision of the amounts (default: %d{defaultOpts.Format.Precision})"
                | Comment _ ->
                ...
                | Locale _ ->
                    $"the locale used to parse decimal values (default: %s{defaultOpts.Locale})"
                | AddDescription _ ->
